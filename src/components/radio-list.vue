<template>
  <div class="tree-radio-list">
    <tree-cell v-for="item in treeData" :key="item.id" :title="item.display || item.name" @on-label-click="$_checkedClick(item)" align="default" :class="[{'parent-not-selectable': !parentSelectable && item.isParent}]">
